...
class TermsController extends GetxController {
  ...
  GlobalKey<ScaffoldState> termsScaffoldKey = new GlobalKey<ScaffoldState>();
  ...
  void openDrawer() {
    termsScaffoldKey.currentState.openDrawer();
  }

  void closeDrawer() {
    termsScaffoldKey.currentState.openEndDrawer();
  }
  ...
  //       QueryOptions(documentNode: gql(QueryClass().queryPrivacy),
  //           context: {
  //             'headers': {
